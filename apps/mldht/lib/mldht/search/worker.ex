defmodule MlDHT.Search.Worker do
  ...
  """
  @spec stop(pid) :: :ok
  def stop(pid), do: GenServer.call(pid, :stop, @call_timeout)
  ...
  def type(pid), do: GenServer.call(pid, :type, @call_timeout)


  def tid(pid), do: GenServer.call(pid, :tid, @call_timeout)
